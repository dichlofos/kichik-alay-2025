...
руководителю и всем участникам {CATEGORY} категорией сложности,
...
мост р. Шала — лед. 310 — пер. Дмитрия Собянина (2А, 4580) — лед. Вост. Кумтор — пер. Скобелева Западный (2А, 4640) —
лед. 89 — д.р. Кекджар — пер. Кекджар (н/к, 4160) — оз. Дамджайлоо —
[пер. Дамджайлоо Восточный + Дамджайлоо Траверсный + пер. Дамджайлоо] (1Б, 4690) —
д.р. Зор-Кумтор — пер. Кичик-Алай (н/к, 4080) — пер. Кичик-Алай-2 (н/к, 4150) — пер. Гезарт Ложный (1Б, 4500) —
пер. Спартакиады (2А, 4640) — д.р. Джума-Су — д.р. Тегермеч — слияние р. Тегермеч
...
|4|Геворков Иван|1989|4 ПУ|Штурман, электрик TODO
...
- Мастер-версия отчёта для чтения: [github.com/dichlofos/kichik-alay-2025/blob/master/report_kichik_alay_2025.md](https://github.com/dichlofos/kichik-alay-2025/blob/master/report_kichik_alay_2025.md), перегенерируется с~помощью скрипта `generate_all.sh`
- Исходный код отчёта: [github.com/dichlofos/kichik-alay-2025/blob/master/source_report_kichik_alay_2025.md](https://github.com/dichlofos/kichik-alay-2025/blob/master/source_report_kichik_alay_2025.md) (туда вносятся все исправления и~дополнения, в~том числе после отправки отчёта в~МКК)
- Репозиторий на GitHub с~материалами отчёта: [github.com/dichlofos/kichik-alay-2025/](https://github.com/dichlofos/kichik-alay-2025/) (треки, фото, отчёты, использованные при подготовке, карты)
...
на 4 блока, примерно равные по площади. С юго-запада на северо-восток его рассекает р.
Кичик-Алай Восточный и дорога вдоль неё через некатегорийный пер. Кичик-Алай.
...
тренировочных спасработах в Подмосковье, содержащих также большое количество
приёмов ТГТ.

Также проводились беговые тренировки, как совместные, так и индивидуальные.

Всё это позволило выйти на маршрут с неплох


К походу третьей категории сложности подразумевалось, что все уч


Часть группы состояла из опытных участников


Поскольку часть группы состояла из 
