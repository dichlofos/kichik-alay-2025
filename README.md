...
- Маршрутная книжка `11/3-304`, [фотокопия прилагается](https://<todo>)
- Ходовых дней: 21
- Протяжённость маршрута: 140 км (GPS, без коэффициентов), в зачёт 138 км
- Максимальная высота: 4690 м
- Максимальная высота ночёвки: TODO м
...
- Версия: 0.01
- На Чемпионате Москвы, согласно протоколам, поход занял [{CHAMP_PLACE} место](https://fst-otm.net/f9.pdf)
...
- TODO [Итоговый судейский протокол](https://fst-otm.net/f9.pdf) от 21.02.2026 в формате PDF
