...
- Маршрутная книжка `{MARSH_NUMBER}`, [фотокопия прилагается]({MARSH_LINK})
...
- Версия: 1.00
- На Чемпионате Москвы 2026 года, согласно протоколам ФСТ-ОТМ, поход занял TODO [??? место]({CHAMP_PROTO})
...
лед. 89 — д.р. Кекджар — пер. Кекджар (н/к, 4160) — озёра Дамджайлоо — пер. Дамджайлоо Восточный (2А, 4660) —
