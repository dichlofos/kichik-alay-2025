...
Отметим, что
а) водители грузовиков не считают данную реку рекой ввиду её малости
б) при использовании грузовиков рекомендуется следить за геолокацией через GPS/телефон
в) некоторые водители не отказываются от оплаты по принципу "сколько не жалко"
